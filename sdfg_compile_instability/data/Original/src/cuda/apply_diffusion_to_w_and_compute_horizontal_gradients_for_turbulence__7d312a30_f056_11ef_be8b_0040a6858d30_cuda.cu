...
DACE_DFI void if_stmt_0_0_0_11(const double&  __arg1__, const double&  __arg2, const bool&  __cond, double&  __output) {
...
int __dace_init_cuda(apply_diffusion_to_w_and_compute_horizontal_gradients_for_turbulence__7d312a30_f056_11ef_be8b_0040a6858d30_state_t *__state, int __area_0_range_0, int __cell_0_range_0, int __connectivity_C2E2CO_stride_0, int __diff_multfac_n2w_0_range_0, int __dwdx_0_range_0, int __dwdx_1_range_0, int __dwdx_stride_1, int __dwdy_0_range_0, int __dwdy_1_range_0, int __dwdy_stride_1, int __geofac_grg_x_0_range_0, int __geofac_grg_x_stride_1, int __geofac_grg_y_0_range_0, int __geofac_grg_y_stride_1, int __geofac_n2s_0_range_0, int __geofac_n2s_stride_1, int __k_0_range_0, int __w_0_range_0, int __w_1_range_0, int __w_old_0_range_0, int __w_old_1_range_0, int __w_old_stride_1, int __w_stride_1, int horizontal_end, int horizontal_start, int vertical_end, int vertical_start) {
    int count;
    ...
    __state->gpu_context = new dace::cuda::Context(6, 26);
...
int __dace_exit_cuda(apply_diffusion_to_w_and_compute_horizontal_gradients_for_turbulence__7d312a30_f056_11ef_be8b_0040a6858d30_state_t *__state) {
...
DACE_EXPORTED bool __dace_gpu_set_stream(apply_diffusion_to_w_and_compute_horizontal_gradients_for_turbulence__7d312a30_f056_11ef_be8b_0040a6858d30_state_t *__state, int streamid, gpuStream_t stream)
{
...
DACE_EXPORTED void __dace_gpu_set_all_streams(apply_diffusion_to_w_and_compute_horizontal_gradients_for_turbulence__7d312a30_f056_11ef_be8b_0040a6858d30_state_t *__state, gpuStream_t stream)
{
    for (int i = 0; i < 6; ++i)
...
void __dace_runkernel_map_1_fieldop_0_0_25(apply_diffusion_to_w_and_compute_horizontal_gradients_for_turbulence__7d312a30_f056_11ef_be8b_0040a6858d30_state_t *__state, const int * __restrict__ connectivity_C2E2CO, const double * __restrict__ geofac_n2s, double * __restrict__ lambda_2___tmp5, const double * __restrict__ w_old, int __connectivity_C2E2CO_stride_0, int __geofac_n2s_0_range_0, int __geofac_n2s_stride_1, int __w_old_1_range_0, int __w_old_stride_1, int horizontal_end, int horizontal_start, int vertical_end, int vertical_start)
{
    ...
    gpuError_t __err = cudaLaunchKernel((void*)map_1_fieldop_0_0_25, dim3(8579, int_ceil(int_ceil(int_ceil((vertical_end - vertical_start), 10), 1), 8), 1), dim3(32, 8, 1), map_1_fieldop_0_0_25_args, 0, __state->gpu_context->streams[5]);
                ...
                if (__coarse_i_K_gtx_vertical < int_ceil((vertical_end - vertical_start), 10)) {
                    ...
                    }
                    {
                        for (auto i_K_gtx_vertical = ((10 * __coarse_i_K_gtx_vertical) + vertical_start); i_K_gtx_vertical < Min(vertical_end, (((10 * __coarse_i_K_gtx_vertical) + vertical_start) + 10)); i_K_gtx_vertical += 1) {
                            ...
                            if_stmt_0_0_0_11(lambda_1___tmp4_0, __inner_double_buffer_for_dwdx, __s0_n7OUT___tmp2_n8None, lambda_1___tmp6_0);
                            ...
                            if_stmt_0_0_0_11(lambda_1___tmp12_0, __inner_double_buffer_for_dwdy, __s0_n7OUT___tmp2_n8None, lambda_1___tmp14_0);
...
void __dace_runkernel_map_8_fieldop_0_0_58(apply_diffusion_to_w_and_compute_horizontal_gradients_for_turbulence__7d312a30_f056_11ef_be8b_0040a6858d30_state_t *__state, const double * __restrict__ area, const int * __restrict__ cell, const int * __restrict__ connectivity_C2E2CO, const double * __restrict__ diff_multfac_n2w, double * __restrict__ dwdx, double * __restrict__ dwdy, const double * __restrict__ geofac_grg_x, const double * __restrict__ geofac_grg_y, const double * __restrict__ geofac_n2s, const int * __restrict__ k, const double * __restrict__ lambda_2___tmp5, double * __restrict__ w, const double * __restrict__ w_old, int __area_0_range_0, int __cell_0_range_0, int __connectivity_C2E2CO_stride_0, int __diff_multfac_n2w_0_range_0, int __dwdx_0_range_0, int __dwdx_1_range_0, int __dwdx_stride_1, int __dwdy_0_range_0, int __dwdy_1_range_0, int __dwdy_stride_1, int __geofac_grg_x_0_range_0, int __geofac_grg_x_stride_1, int __geofac_grg_y_0_range_0, int __geofac_grg_y_stride_1, int __geofac_n2s_0_range_0, int __geofac_n2s_stride_1, int __k_0_range_0, int __w_0_range_0, int __w_1_range_0, int __w_old_0_range_0, int __w_old_1_range_0, int __w_old_stride_1, int __w_stride_1, const double diff_multfac_w, const int halo_idx, int horizontal_end, int horizontal_start, const int interior_idx, const int nrdmax, int vertical_end, int vertical_start)
{
